...
def setup_logging():
    ...
    # File handler for the interaction API
    interaction_file_handler = logging.FileHandler("interaction_api.log")
    interaction_formatter = logging.Formatter('%(asctime)s - %(name)s - %(levelname)s - %(message)s')
    interaction_file_handler.setFormatter(interaction_formatter)
    ...
    logger.addHandler(interaction_file_handler)
